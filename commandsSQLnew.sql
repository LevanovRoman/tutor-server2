...
--     passwordOrigin VARCHAR(255),
--     role VARCHAR(15) NOT NULL
--     );

create table users (id bigint not null auto_increment, email varchar(255), first_name varchar(255),
                    last_name varchar(255), password varchar(255), password_origin varchar(255),
